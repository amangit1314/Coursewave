...
const About = () => {
  ...
  //     description:
  //       "Learn from industry professionals with 10+ years of experience at top tech companies",
  ...
  //     description:
  //       "Join 50,000+ developers worldwide. Network, collaborate, and grow together",
  ...
  const { data: statsData, isLoading, error } = usePlatformStats();
  ...
  // Updated stats with real data from the hook
  const stats = [
    {
      icon: Users,
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Stats animation - only trigger when stats are loaded
      if (!isLoading && stats) {
        gsap.fromTo(
          ".stat-item",
          { y: 30, opacity: 0 },
    ...
    return () => ctx.revert();
  }, [isLoading, stats]); // Re-run when stats load
  ...
  if (isLoading) {
    return (
      <section
        ref={sectionRef}
        className="relative py-20 bg-white dark:bg-zinc-900"
      >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col space-y-12 sm:space-y-16 lg:space-y-20">
          ...
          >
            ...
            <h1
              id="about-heading"
              className={`${dmSans.className} about-title text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl lg:text-5xl xl:text-6xl`}
            >
            ...
            <p className="about-subtitle mx-auto mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg lg:text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              careers with our comprehensive, industry-aligned learning platform
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:gap-16 xl:gap-20 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-6">
                <h2
                  className={`${dmSans.className} text-2xl font-bold text-slate-900 dark:text-white sm:text-3xl lg:text-4xl leading-tight`}
                >
                  Your Gateway to{" "}
                ...
                <div className="space-y-3 sm:space-y-4 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                  <p>
                    CourseWave is more than a platform — it&apos;s your
                    launchpad into the tech world. Learn, build, and grow with
                    an ecosystem that empowers anyone, anywhere, to master
                    in-demand skills and accelerate their career.
                  </p>
                  <p>
                    Learn from industry experts, build real projects, and grow
                    with a community that pushes you to master the skills
                    shaping tomorrow&apos;s tech world.
                  </p>
                </div>
              </div>
          ...
          >
            <div className="text-center mb-8 sm:mb-12">
              <h3
                className={`${dmSans.className} text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-3 sm:mb-4`}
              >
                Why Choose CourseWave?
              </h3>
              <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                Experience the difference with our comprehensive learning
                ecosystem
              </p>
            </div>
              ...
              <div className="relative p-8 sm:p-12">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-zinc-600 dark:text-gray-300 max-w-2xl mx-auto">
                    Ride the wave of growth with thousands of developers
                    who&apos;ve advanced their careers.
                  </p>
                </div>
...
const FeatureCard = ({ icon: Icon, title, description, color, index }: any) => {
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
    >
      <div className="h-full rounded-2xl border border-slate-200 bg-white p-6 dark:shadow-lg transition-all duration-500 hover:shadow-2xl hover:border-transparent dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-transparent">
        ...
        <div className="relative flex flex-col space-y-4">
          {/* Icon */}
          <div
            className={`inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r ${color} shadow-lg`}
          >
          ...
          <div className="space-y-2">
            <h4
              className={`${dmSans.className} text-lg font-semibold text-zinc-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors`}
            >
              {title}
            </h4>
  ...
  return (
    ...
    >
      <div className="space-y-2 sm:space-y-3">
        <div
          className={`mx-auto inline-flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-gradient-to-r ${color} shadow-lg transition-transform group-hover:scale-110`}
        >
          <Icon className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
        </div>
        <div className="space-y-1">
          <div
            className={`${dmSans.className} text-xl sm:text-2xl font-bold text-slate-900 dark:text-white`}
          >
            {value}
          </div>
