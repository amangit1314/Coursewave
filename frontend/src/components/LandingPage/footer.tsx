...
//   },
//   {
//     link: "/legal/helpAndSupport",
//     name: "Help and Support",
//   },
//   {
//     link: "/",
//     name: "Contact Us on gitaman818@gmail.com",
//   },
// ];
...
//       {/* Newsletter */}
//       {/* <div className="flex items-center justify-center bg-transparent px-4 py-8 sm:px-6 lg:px-8">
//         <Newsletter />
//       </div> */}
...
//                 </div>
//                 <p
//                   className={`${poppins.className} max-w-xs text-sm text-slate-400`}
//                 >
//                   Empowering developers worldwide with cutting-edge courses,
//                   mentorship, and a vibrant community.
//                 </p>
//               </div>
