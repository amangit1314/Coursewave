...
//       <div className="flex h-16 w-full items-center justify-between px-4 sm:h-20 sm:px-6 lg:px-8 space-x-4">
//         {/* Logo */}
//         <Link
//           href="/"
...
//             className="h-8 w-8"
//           />
//           <p className="font-dm-sans text-lg font-extrabold capitalize tracking-tight text-blue-500 sm:text-xl">
//             Coursewave
//           </p>
//         </Link>
...
//               key={link.link}
//               href={link.link}
//               className="font-dm-sans text-sm font-medium text-gray-800 transition-colors duration-200 hover:text-blue-500 dark:text-white dark:hover:text-blue-500"
//             >
//               {link.name}
//             </Link>
//           ))}
...
//                         onClick={handleLoginClick}
//                         variant="outline"
//                         className="font-dm-sans group relative w-full justify-center border-2 border-blue-500/20 bg-transparent text-sm font-semibold tracking-wide text-blue-600 transition-all duration-300 hover:border-blue-500 hover:bg-blue-50 hover:shadow-lg dark:border-blue-400/20 dark:text-blue-400 dark:hover:border-blue-400 dark:hover:bg-blue-950/20"
//                       >
