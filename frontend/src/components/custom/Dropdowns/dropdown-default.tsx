  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`border-stroke shadow-default dark:border-strokedark dark:bg-boxdark absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border bg-white p-1.5 ${
