...
//                   className="pl-10 border border-zinc-200 dark:border-zinc-800 rounded-lg"
//                 />
//               </div>
//             </div>
...
//               className="rounded-lg border border-zinc-300 bg-white px-3 py-1 text-sm dark:border-zinc-600 dark:bg-zinc-800"
//             >
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                size="icon"
                onClick={() => setViewMode("grid")}
                className="rounded-lg border border-zinc-200 dark:border-zinc-800 focus:ring-2 focus:ring-blue-500"
