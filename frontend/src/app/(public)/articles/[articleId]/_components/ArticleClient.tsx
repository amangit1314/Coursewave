...
const ArticleClient = ({ articleId }: { articleId: string }) => {
  ...
  // Error state
  if (error) {
    return <ArticleErrorWidget error={error} />;
  }

  // Not found state
  if (!article) {
    return <ArticleNotFoundWidget />;
  }
    ...
    <div className="h-full flex flex-col overflow-x-hidden">
      ...
      <div className="">
        <motion.div
          ...
          className="mx-4 my-8 md:my-16 w-full space-y-8 overflow-x-hidden md:mx-auto md:max-w-3xl"
        >
          {/* article title */}
