    ...
    return (
      <div className="relative mb-4">
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="absolute cursor-pointer right-0 top-0 text-black hover:text-blue-600 dark:Text-blue-800 duration-300 transition-all h-full px-3 py-2 hover:bg-transparent"
