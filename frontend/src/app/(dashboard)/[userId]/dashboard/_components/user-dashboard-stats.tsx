...
export default function UserDashboardStats({
  ...
  return (
    <ScrollArea className="w-full">
      <div className="mx-auto grid w-full max-w-7xl gap-4 py-6 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-zinc-800 shadow-sm border border-zinc-200 dark:border-zinc-700 p-6 transition-all duration-300 hover:shadow-md">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${stat.bgColor} ${stat.iconColor} border ${stat.borderColor} transition-all duration-300 group-hover:scale-110`}>
                    <stat.icon size={24} />
                  </div>
