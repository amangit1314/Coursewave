...
import CategoriesComponent from "@/app/(courses)/courses/_components/CategoriesComponent";
import { FilteredCoursesComponent } from "@/app/(courses)/browse/_components/FilteredCourses";
