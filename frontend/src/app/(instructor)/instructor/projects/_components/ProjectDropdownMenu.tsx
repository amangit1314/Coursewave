...
const ProjectDropdownMenu = ({ project }: ProjectDropdownMenuProps) => {
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div className="relative w-full max-w-md rounded-2xl shadow-2xl p-6 animate-in zoom-in-95 duration-200 bg-white dark:bg-gray-800 dark:border dark:border-gray-700">
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-300">
                Are you sure you want to delete <strong>&quot;{project.title}&quot;</strong>? This action cannot be undone and all associated data will be permanently removed.
              </p>
