...
const EarningsDashboard = () => {
  ...
  const stats = {
    ...
    pendingPayouts: 2340.0,
    completedPayouts: 10110.0,
    thisMonth: 3280.0,
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-zinc-400">
            Manage your income, track payments, and access financial documents
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {earnings.slice(0, 3).map((earning) => (
                      <div
                        key={earning.id}
                        className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-900 rounded-lg"
                      >
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-zinc-400">
                            {earning.students} students • {earning.date}
                          </p>
                        </div>
                        <div className="text-right">
                          ...
                          <div
                            className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs ${getStatusColor(earning.status)}`}
                          >
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border border-gray-200 dark:border-zinc-700 rounded-md">
                    <thead className="bg-gray-50 dark:bg-zinc-900">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-600 dark:text-zinc-300 uppercase">
                          Course
                        </th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-600 dark:text-zinc-300 uppercase">
                          Date
              ...
              <div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
                        Minimum payout amount is $50. Payouts are processed
                ...
                <div className="space-y-4">
                  {payoutRequests.map((payout) => (
                    <div
                      key={payout.id}
                      className="border border-gray-200 dark:border-none dark:bg-zinc-900 rounded-lg p-4"
                    >
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div
                          className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm ${getStatusColor(payout.status)}`}
                        >
              ...
              <div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-1">
                        Please consult with a tax professional for guidance on
                        reporting your earnings. These documents are provided
                ...
                <div className="space-y-4">
                  {taxDocuments.map((doc) => (
                    <div
                      key={doc.id}
                      className="border border-gray-200 dark:border-none dark:bg-zinc-900 rounded-lg p-4 hover:border-blue-300 dark:hover:border-blue-500 transition"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-zinc-400">
                              Total: ${doc.amount.toLocaleString()} • Generated:{" "}
                              {doc.date}
                            </p>
                          </div>
                        </div>
              ...
              <div>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-none rounded-lg p-6">
                  <h3 className="text-xl font-bold mb-6 text-gray-900 dark:text-white">
                    Financial Summary - October 2025
                  </h3>
