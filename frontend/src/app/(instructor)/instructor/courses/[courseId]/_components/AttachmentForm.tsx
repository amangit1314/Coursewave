...
// import { useAddAttachment, useCourseAttachments, useDeleteAttachment } from "@/hooks/useCourses";
...
//                       <button
//                         onClick={() =>
//                           handleAttachmentClick(attachment as CourseAttachment)
//                         } // todo: to check the as expression use in this context
...
//                   <FormControl>
//                     <Input
//                       className="w-full border-gray-700 dark:border-gray-400 dark:bg-zinc-800"
//                       type="text"
...
//                 💡 <strong>Supported Resources:</strong> PDFs, Google Drive
