...
import { Editor } from "@/app/(shared)/ReactQuillEditor";
...
export const ChapterDescriptionForm = ({
  ...
  const sectionId = initialData.id;
  ...
  return (
    <div className="mt-6 rounded-xl border bg-slate-100 p-4 transition-all duration-300 dark:bg-zinc-800 md:mt-0">
      <div className="flex items-center justify-between font-medium">
        <h3 className="text-zinc-800 dark:text-white tracking-tight font-semibold">
          {" "}
          Chapter description{" "}
        </h3>
        ...
        <Button
          onClick={toggleEdit}
          variant="ghost"
          className="hover:bg-white dark:hover:bg-black dark:hover:text-white transition-all duration-100 overflow-hidden"
        >
          {isEditing ? (
