...
import {
  ...
  Loader2, Filter, ChevronRight, Sparkles, Monitor, Pencil,
} from "lucide-react";
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <div
                  key={f.label}
                  className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm text-white/90 text-xs font-medium px-3 py-1.5 rounded-full"
                >
