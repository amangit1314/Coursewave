...
//         <div className="mb-8 px-4 pt-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 relative border-b pb-4">
//           {/* Back Button */}
//           <Button
//             onClick={() => window.history.back()}
//             variant="ghost"
//             className="w-fit flex items-center gap-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950"
//           >
//             <ArrowLeft size={20} />
...
//             <h1
//               className={cn(
//                 "text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-1",
//                 dmSans.className
//               )}
//             >
//               Shopping Cart
...
//               {items.length === 1 ? "course" : "courses"} in your cart
//             </p>
//           </div>
...
//               onClick={() => clearCart()}
//               variant="outline"
//               className="text-red-600 border-red-200 hover:bg-red-50 dark:hover:bg-red-950 px-4 py-2 rounded-lg shadow flex items-center gap-2"
//               disabled={clearing}
//             >
//               <Trash2 size={18} />
//               Clear Cart
...
//               <Card
//                 key={item.id}
//                 className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-zinc-800 overflow-hidden"
//               >
//                 <CardContent className="p-6">
//                   <div className="flex flex-col sm:flex-row gap-6">
//                     <div className="relative flex-shrink-0 w-full sm:w-48 h-32 rounded-xl overflow-hidden">
//                       <Image
...
//                       {/* Optionally show duration, avg rating, etc */}
...
//                             <span>{item.Course.averageRating}</span>
//                           </div>
//                         )}
//                       </div>
...
//             {/* Empty State */}
//             {items.length === 0 && (
//               <Card className="border-0 shadow-lg dark:bg-zinc-800 text-center py-16">
//                 <CardContent>
...
//                     Start adding some courses to your cart!
//                   </p>
...
//             <Card className="border-0 shadow-xl dark:bg-zinc-800 sticky top-24">
//               <CardContent className="p-6">
//                 <h2
//                   className={cn(
...
//                       <div
//                         key={coupon.code}
//                         className="flex items-center justify-between p-3 border border-gray-200 dark:border-zinc-700 rounded-lg hover:border-blue-300 dark:hover:border-blue-600 cursor-pointer"
//                         onClick={() => {
