...
// const LearningHeader = ({ title, progress = 0 }: LearningHeaderProps) => {
//   return (
...
//         {/* Left: Enhanced Back Button + Modern Breadcrumb */}
//         <div className="flex min-w-0 flex-1 items-center space-x-4">
//           {/* Enhanced Back Button */}
//           <button
//             className="group relative flex items-center gap-2 rounded-xl border border-gray-200/60 bg-white/50 px-3 py-2 text-gray-700 transition-all duration-200 hover:border-gray-300 hover:bg-white hover:shadow-md hover:shadow-black/10 active:scale-95 dark:border-white/10 dark:bg-white/5 dark:text-gray-200 dark:hover:border-white/20 dark:hover:bg-white/10 dark:hover:shadow-white/10"
//             onClick={() =>
...
//             {/* Subtle hover effect */}
//             <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-600/10 to-purple-600/10 opacity-0 transition-opacity duration-200 group-hover:opacity-100" />
//           </button>
...
//               <div className="rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 p-1.5">
//                 <BookOpen className="h-3 w-3 text-white" />
//               </div>
//               <span className="truncate font-semibold text-gray-900 dark:text-white max-w-xs lg:max-w-md">
//                 {title}
//               </span>
...
//         {/* Right: Enhanced Progress + Actions */}
//         <div className="ml-4 flex shrink-0 items-center space-x-3">
//           {progress > 0 && (
//             <div className="hidden sm:flex items-center gap-3 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100/50 px-4 py-2 dark:from-white/5 dark:to-white/10">
...
//             <div className="rounded-xl bg-white/50 p-1 dark:bg-white/5">
//               <ThemeModeToggle />
//             </div>
