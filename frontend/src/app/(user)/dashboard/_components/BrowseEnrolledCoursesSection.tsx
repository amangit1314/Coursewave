...
import CategoriesComponent from "@/app/(public)/courses/_components/CategoriesComponent";
import FilteredCoursesComponent from "@/app/(public)/browse/_components/FilteredCourses";
