...
const PremiumArticleEditor = () => {
  ...
  return (
    <div
      className={`min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-50 to-white dark:from-zinc-900 dark:to-zinc-800 transition-all duration-300 ${isFullscreen ? "fixed inset-0 z-50" : ""}`}
    >
      <Toaster />
      ...
      <div className="w-[100vw] mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-700 overflow-hidden">
              ...
              <div className="p-6">
                <textarea
                  ...
                  className="w-full h-96 bg-transparent border-none outline-none resize-none text-zinc-700 dark:text-zinc-300 placeholder-zinc-400 dark:placeholder-zinc-500 leading-relaxed"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 text-sm border border-zinc-200 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800"
                  />
                </div>
              </div>
            </div>
