  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-start space-x-2">
        ...
        <div className="flex items-center justify-start space-x-1">
          ...
          <p className="text-xs uppercase">
            {article.readTime
              ? article.readTime.toString() + " min read"
              : "6 min read"}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-1">
        {/* leading-1 */}
        <p className=" line-clamp-2 text-lg font-bold tracking-tight text-zinc-800 dark:text-white">
          {article.title
            ? article.title
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-4 px-1">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-64 rounded-xl bg-white dark:bg-zinc-800">
              <DropdownMenuGroup>
