...
const ArticleClient = ({ articleId }: { articleId: string }) => {
  ...
  const { fetchSelectedArticle, selectedArticle, loading, error } =
    useArticlesStore();
  ...
  if (loading) {
    return (
      <div className="max-w-7xl overflow-x-hidden px-10 py-8 text-center">
        <p className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-white">
          Article info
        </p>
        <p className="text-base text-yellow-500">Loading article...</p>
      </div>
    );
  }
  ...
  const article: BlogArticle = selectedArticle!;
  ...
  console.log("Article just before build ui:", article);
      ...
      <div className="mx-8 my-16 w-full space-y-8 overflow-x-hidden md:mx-auto md:max-w-3xl">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-4 px-1">
            {/* views count */}
            <div className="flex cursor-pointer items-center justify-start space-x-2 transition-all duration-300 ">
              <AiOutlineEye size={18} />
              <div className="mt-1 text-xs">
                {article?._count?.views?.toString() ?? 0}
              </div>
            </div>
            ...
            <div className="flex cursor-pointer items-center justify-start space-x-2 transition-all duration-300 hover:text-zinc-900 dark:hover:text-white">
              ...
              <div className="mt-1 text-xs">
                {article?._count?.likes?.toString() ?? 0}
              </div>
            </div>
            ...
            <div className="flex cursor-pointer items-center justify-start space-x-2 transition-all duration-300 hover:text-zinc-900 dark:hover:text-white">
              ...
              <div className="mt-1 text-xs">
                {article?._count?.comments?.toString() ?? 0}
              </div>
            </div>
          </div>
        ...
        <ArticleAuthorCard
          ...
          authorName={article?.author?.name ?? "Unknown"}
          authorBio=""
          // authorFollowers={article?.author?._count?.followers ?? 0}
          authorFollowers={0}
  ...
  return (
    <div className="h-full min-h-screen justify-center overflow-x-hidden">
      ...
      <div className="mx-8 my-16 w-full space-y-8 overflow-x-hidden md:mx-auto md:max-w-3xl">
        ...
        {/* <ArticleAuthorInfo
          authorId={article?.authorId}
          estimatedReadingTime={article?.readTime.toString()}
        ...
        <ArticleAuthorCard
          ...
          authorName={article?.author?.name ?? "Unknown"}
          authorBio={article?.author?.shortSummary ?? ""}
          // authorFollowers={article?.author?._count?.followers ?? 0}
          // haveAlreadyFollowed={article?.author?.isAlreadyFollowed ?? false}
          // authorBio=""
          authorFollowers={0}
          haveAlreadyFollowed={false}
        />
