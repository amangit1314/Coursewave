    ...
    <div className="h-full min-h-screen justify-center overflow-x-hidden">
      ...
      <div className="mx-8 my-16 w-full space-y-8 overflow-x-hidden md:mx-auto md:max-w-3xl">
        ...
        <ArticleAuthorInfo
          ...
          authorProfileImageUrl={article?.author.profileImageUrl ?? ""}
          ...
          <div className="flex space-x-4 px-1">
            ...
            <div className="flex cursor-pointer items-center justify-start space-x-2 transition-all duration-300 hover:text-zinc-900 dark:hover:text-white">
              ...
              <div className="mt-1 text-xs">
                {article?._count.likes ? article?._count.likes : 0}
              </div>
            </div>
            ...
            <div className="flex cursor-pointer items-center justify-start space-x-2 transition-all duration-300 hover:text-zinc-900 dark:hover:text-white">
              ...
              <div className="mt-1 text-xs">
                {article?._count.comments
                  ? article?._count.comments.toString()
                  : 0}
              </div>
            </div>
          </div>
        ...
        <ArticleAuthorCard
          ...
          authorImage={article?.author.profileImageUrl ?? ""}
          authorName={article?.author.name ?? "Unknown Author"}
          authorBio={article?.author.about ?? "No bio available"}
          // authorFollowers={article?.author.followersCount ?? 0}
          authorFollowers={0}
          // haveAlreadyFollowed={article?.author.haveAlreadyFollowed ?? false}
