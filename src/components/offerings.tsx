      ...
      <div className="max-h-screen max-w-7xl mb-12 w-full h-full">
          ...
          <div className="mx-auto mt-8 mb-16 grid text-center grid-cols-2 lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
              ...
              <a
                  ...
                  className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-blue-500 dark:hover:border-none hover:bg-white dark:hover:bg-slate-700"
                  target="_blank"
