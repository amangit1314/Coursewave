...
const ChatCard = () => {
  return (
    <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark col-span-12 rounded-sm border bg-white px-5 pb-2.5 pt-6 xl:col-span-4">
