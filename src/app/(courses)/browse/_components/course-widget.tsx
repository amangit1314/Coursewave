...
const CourseWidget = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <p className="text-xs text-black dark:text-slate-400 font-medium pt-3">
          {courseNumber}
        </p>
        <p className="text-xl font-semibold text-slate-900 dark:text-slate-300 line-clamp-2">
          {title}
        </p>
        ...
        <div className="w-full py-2 flex flex-col">
          <div className="flex justify-start items-center py-auto">
            ...
            <p className="pl-1 text-xs text-slate-400 font-medium ">
              {instructor}{" "}
            </p>
          </div>
          {/* categories */}
          <div>
            <div className="text-xs text-black dark:text-slate-400 font-medium pt-3">
              Categories
            </div>
            <div className="pt-2 grid grid-cols-2 gap-2">
              {categories && categories.length > 0 ? (
                ...
                <span>
                  <Badge
                    className="text-xs text-blue-500 font-normal border-blue-500"
                    key={index}
                    variant="outline"
                  >
                    Default
        ...
        <div className="flex w-full justify-between gap-x-20 md:gap-x-0 ">
          <div>
            <div className="flex">
              ...
              <p className="text-xs text-black uppercase dark:text-slate-400 font-medium pt-3 ">
                Estimated Duration
              </p>
            </div>
            <div className="flex justify-start text-lg font-semibold text-blue-500 dark:text-gray-200 items-center py-auto">
              {duration} Days
            </div>
          ...
          <div className="pt-4 pl-5">
            ...
            {/*  ₹ */}
            <div className="flex justify-center text-xl font-semibold text-blue-500 dark:text-white items-center py-auto">
              {price}
            </div>
          </div>
        </div>
