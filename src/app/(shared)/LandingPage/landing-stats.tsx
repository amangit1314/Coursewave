...
const LandingCoursewaveStats = () => {
  ...
  const statsData = [
    ...
    },
    {
      ...
      description: "Join a thriving community of developers advancing their careers",
  ...
  const achievements = [
    { icon: Star, text: "95% Success Rate", color: "text-yellow-500" },
    ...
    <div ref={sectionRef} className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col space-y-16">
        ...
        >
          ...
          <h2 className="stats-title text-3xl font-bold tracking-tight text-zinc-800 dark:text-white sm:text-4xl lg:text-5xl">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="rounded-2xl bg-gradient-to-r from-zinc-50 to-blue-50 p-8 dark:from-zinc-900/50 dark:to-blue-950/20">
            <div className="text-center">
              <h3 className="mb-6 text-xl font-semibold text-zinc-800 dark:text-white sm:text-2xl">
...
const StatCard = ({ icon: Icon, number, title, description, gradient, bgGradient, darkBgGradient }: any) => {
  return (
    ...
    >
      {/* Background Gradient */}
      <div className={`absolute inset-0 bg-gradient-to-br ${bgGradient} opacity-0 transition-opacity duration-300 group-hover:opacity-10 dark:${darkBgGradient}`} />
      
      {/* Icon */}
      <div className={`mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-r ${gradient} shadow-lg`}>
      ...
      <div className="relative space-y-4">
        <div className="space-y-2">
          <h3 className="text-3xl font-bold text-zinc-800 dark:text-white sm:text-4xl">
