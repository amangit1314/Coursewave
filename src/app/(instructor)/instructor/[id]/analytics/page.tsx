...
function Analytics() {
  return (
    <div className='dark:bg-[#1a222c' >

      <div className="px-[5rem] pt-[90px] grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      ...
      <div className='px-[5rem] pt-[5px]'>
        {/* <div className='font-semibold pt-4 '>Analytics Graph</div>
        <AreaChartDemo /> */}
