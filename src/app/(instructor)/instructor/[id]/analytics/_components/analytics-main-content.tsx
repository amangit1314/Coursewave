...
import EarningReportAreaChart, {
  EarningChartData,
} from "./earning-report-chart";
...
const Analytics = ({
  ...
  const earningChartData = useMemo((): EarningChartData[] => {
    ...
    createdCourses.forEach((course) => {
      ...
      monthlyEarnings[month] += parseFloat(course.price) || 0;
    });
  ...
  return (
    <div className="flex h-auto justify-center pb-12 dark:bg-zinc-900">
      ...
      <div className="mr-[2rem] mt-[3rem] w-[22rem] pt-[50px]">
        <TotalRevenueCard totalEarning={totalEarning} courses={createdCourses} />
