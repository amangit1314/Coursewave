...
export function SessionCard({sessionName, sessionImage, instructor}: any) {
    return (
      <div className="h-[18rem] cursor-pointer mt-2 shadow-md bg-white dark:bg-slate-800 w-[15rem] rounded-xl ">
        <Image
        ...
        <div className="flex flex-col pt-3 px-3">
          ...
          <span className="text-md mt-[10px] font-medium text-gray-800 line-clamp-2 dark:text-slate-100">
            {sessionName}
          </span>
          ...
          <div className="flex justify-between mt-3">
            <div className="flex items-center py-auto">
              ...
              <p className="text-xs hover:underline text-gray-600 ml-[4px] dark:text-gray-400">
                {instructor}
              </p>
            </div>

            <div className="p-2 text-xs font-bold hover:text-indigo-500 cursor-pointer dark:text-slate-300 dark:hover:text-white">
              Join Now
            </div>
          </div>
        </div>
