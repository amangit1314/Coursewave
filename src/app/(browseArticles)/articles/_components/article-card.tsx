...
export const ArticleCard = ({ articleId }: any) => {
  return (
    <Link
    ...
    >
      <Image
        src={
          // "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWjGHKcLhdGFVRRdfQ8TgYEQVgwKbcHjnXzA&usqp=CAU"
      ...
      <div className="flex space-x-2 justify-start items-center">
        ...
        <div className="flex justify-start items-center space-x-1">
          ...
          <p className="text-xs uppercase">6 min read</p>
        </div>
      </div>
