...
import { HiOutlineGift, HiOutlineShoppingCart, HiShoppingCart } from 'react-icons/hi';
            ...
            <div className='flex'>
                <div className='pt-[75px]  flex flex-col text-red items-start justify-center text-start text-xl'>
                    <div className='pl-6 md:pl-0 flex justify-center '>
                        <p className='text-sm text-blue-500 dark:text-blue-400'>Development</p>
                        <p className='text-sm text-blue-500 dark:text-blue-400'>{course?.courseCategories}</p>
                    </div>

                    <div className='flex flex-col'>
                        <p className='pl-6 md:pl-0 font-semibold text-2xl'> {course?.courseTitle} </p>
...
function CourseDetailLeftSection({ isInCart, toggleIsInCart }: CourseDetailLeftSectionParams) {
    ...
    return (
        <div className='hidden md:flex md:flex-col relative w-[30rem] ml-[8rem] mt-[75px] shadow-lg z-99 shadow-gray-950 rounded-lg bg-slate-800 border-gray-500 max-h-[23rem]'>
            <Image
                ...
                src={'https://media.geeksforgeeks.org/wp-content/cdn-uploads/20210301154221/System-Design-Live-Course-By-GeeksforGeeks.png'}
                alt="Next.js Logo"
                width={400}
                height={40}
                style={{
            ...
            <Badge onClick={toggleIsInCart} className='flex justify-center items-center rounded-full h-10 w-10 bg-indigo-500 absolute mt-1 bottom-29 hover:bg-indigo-600 right-2'>{isInCart ? <HiOutlineShoppingCart style={iconStyle} /> : <HiShoppingCart style={iconStyle} />}</Badge>
            ...
            <div className='p-4'>
                ...
                <button type='submit' className='mt-2 bg-indigo-500 w-[18rem] rounded-lg hover:bg-indigo-700 text-sm text-white font-semibold p-2'>
                    Buy Now
                </button>

                <p className='text-center text-xs py-2 text-gray-400 font-thin'>30 Day money back guarantee</p>
...
function WhatYouWillLearn() {
    return <div className='mt-2 md:py-8 md:mt-0 md:p-0 p-6 flex '>
        <div className="flex flex-col p-4 max-w-3xl text-start text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-xl tracking-tight font-semibold">What you will learn!</h3>
    ...
    return (
        <div className='flex justify-between items-center py-auto'>
            <div className='flex flex-col items-start mt-2 p-6 md:p-0'>
                <h3 className="mb-4 tracking-tight text-xl font-semibold">This course includes:</h3>
...
function ThisCourseIncludesItem({ icon, text }: any) {
    return <div
        ...
        <div>{icon}</div>
        <p className='pl-3 md:pl-2 text-md text-gray-700 dark:text-gray-400'>{text}</p>
    </div>
}

function CourseContent() {
    return <div className='p-6 md:mt-4 md:p-0 max-w-3xl pb-4 md:pb-6'>
        <h3 className="mb-4 tracking-tight text:lg md:text-xl font-semibold">Course Content:</h3>
...
function Prerequisits() {
    return (
        <div className='md:mt-4 p-6 md:p-0 max-w-3xl justify-start'>
            <h3 className="mb-4 text-xl tracking-tight font-semibold">Prerequisits:</h3>
...
function WhoThisCourseIsFor() {
    return (
        <div className='md:mt-4 p-6 md:p-0 text-base max-w-3xl justify-start'>
            <h3 className="mb-4 text-xl tracking-tight font-semibold">Who this course is for:</h3>
            <ul className='pl-4 flex flex-col text-gray-700 dark:text-gray-400 text-md justify-between pb-2 list-disc'>
                <li className='pb-1'>Office workers, students, small/home business workers, and administrators would want to improve their productivity</li>
                <li className='pb-1'>Computer users who have heard the {"learn to code"} message, but want practical reasons to learn programming.</li>
                <li>While this course doesnt cover specific devops tools, this course would be useful for QA, devops, and admins who want to learn scripting in Python.</li>
            </ul>
        </div>
    );
}
        ...
        <div>
            ...
            <div>
                <div className="flex items-center space-x-2 text-base">
                    <h4 className="font-semibold tracking-tight text-slate-900 dark:text-white">Technologies Learnt in this course</h4>
...
function Description() {
    return (
        <div className='md:mt-4 p-6 md:p-0 max-w-3xl justify-start'>
            <h3 className="mb-4 text-xl tracking-tight font-semibold">Description:</h3>
            <div className="bg-transparent pb-2">

                <p className="text-md text-gray-700 dark:text-gray-400">Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas.</p>
                ...
                <div className="text-md pt-4 text-base text-gray-700 dark:text-gray-400 ">
                    ...
                    <ul role="list" className="mt-8 space-y-8 text-gray-600">
                        <li className="flex gap-x-3">
                            ...
                            <span className='dark:text-gray-400 text-gray-700'><strong className="font-semibold dark:text-gray-300 text-gray-900">Push to deploy.</strong> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</span>
                        </li>
                        <li className="flex gap-x-3">
                            <svg className="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clip-rule="evenodd" />
                            </svg>
                            <span className='dark:text-gray-400 text-gray-700'><strong className="font-semibold dark:text-gray-300 text-gray-900">SSL certificates.</strong> Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span>
                        </li>
                        <li className="flex gap-x-3">
                            <svg className="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            ...
                            <span className='dark:text-gray-400 text-gray-700'><strong className="font-semibold dark:text-gray-300 text-gray-900">Database backups.</strong> Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className='dark:p-5 dark:border dark:border-gray-700 rounded-xl'>
                <div className='flex'>
                    ...
                    <div className='ml-4 md:ml-6 items-start mr-auto text-base'>
                        ...
                        <p className='text-sm text-gray-700 dark:text-gray-400 font-thin '>Full Stack Engineer</p>
                    </div>
                </div>
...
function CourseRatings() {
    ...
    return (
        <div className='group md:mt-4 p-6 md:p-0 max-w-7xl items-center justify-start'>
            ...
            <div className={`grid bg-white dark:bg-transparent gap-2 ${showAllItems ? 'grid-cols-3 grid-flow-col' : 'grid-rows-2 grid-cols-3'}`}>
                <CourseRatingItem />
                <CourseRatingItem />
                <CourseRatingItem />
                <CourseRatingItem />
        ...
        <div className='p-5 bg-slate-100 dark:bg-slate-800 dark:border dark:border-gray-700 rounded-md max-w-[25rem]'>
            <div className='flex'>
                ...
                <div className='ml-4 items-start mr-auto text-base'>
                    <p className='text-md tracking-tight font-semibold'>Aman Soni</p>
                    <p className='text-sm text-gray-600 dark:text-gray-400 font-thin '>Full Stack Engineer</p>
                </div>
            </div>
...
function MoreCoursesBy() {
    ...
    return (
        <div className='group md:mt-4 p-6 md:p-0 max-w-7xl items-center justify-start'>
            ...
            <div className={`grid bg-white dark:bg-transparent gap-2 ${showAllItems ? 'grid-cols-3 grid-flow-row' : 'grid-rows-2 grid-cols-3'}`}>
