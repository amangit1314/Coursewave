  ...
  return (
    <div className="flex flex-col py-[2rem] ">
      <div className="flex max-w-7xl">
        {/* right part */}
        <div className="pt-[50px]  flex flex-col text-red items-start justify-center text-start text-xl">
          {/* course breadcrumb */}
            ...
            <ul>
              ...
              <li>
                <a>
                  ...
                  All
                  {/* {course?.courseCategories ? course?.courseCategories : 'All'} */}
                </a>
              </li>
              <li>
          ...
          <div className="flex flex-col">
            ...
            {/* <div className="max-w-3xl mt-4 max-h-2xl h-full w-full">
              <video
                className="smooth-content  h-[512px] rounded-xl object-cover w-3xl bg-blue-200"
                width="768"
                height="512"
                loop
                autoPlay
            ...
            <div className="pl-6 mt-2 md:mt-0 md:p-0 flex flex-wrap md:flex md:flex-row justify-start">
              <RatingStars />
              <div className="flex flex-row">
                <p className="mx-1 cursor-pointer text-sm font-medium text-blue-500 dark:text-blue-400">{`(${239} ratings)`}</p>
                <Badge className="mx-1 flex justify-center items-center text-xs font-medium text-slate-200 rounded-full hover:bg-slate-900 bg-blue-500 ">{`${1456} enrollements`}</Badge>
              </div>
            </div>
      ...
      <div className="flex mt-1 max-w-7xl flex-col">
        <ThisCourseIncludes />
  ...
  return (
    <div className="p-6 md:mt-4 md:p-0 max-w-3xl pb-4 md:pb-6">
      ...
      <div className="flex justify-between pb-2">
        <div className="flex flex-wrap md:flex justify-evenly text-gray-700 dark:text-gray-400">
          {/* sections */}
      ...
      <div className="dark:p-5 dark:border dark:border-gray-700 rounded-xl">
        <div className="flex">
          ...
          <div className="ml-4 md:ml-6 items-start mr-auto text-base">
            <p className="text-md text-gray-800 dark:text-slate-200 tracking-tight font-semibold">
              Aman Soni
            </p>
        ...
        <p className="text-md hidden md:visible text-base pt-6 md:py-2 md:text-md md:p-0 md:pr-[8rem] w-auto line-clamp-5 md:line-clamp-3 font-noraml text-gray-700 dark:text-gray-400">
          ...
          <div className="stat-figure text-secondary">
            <div className="avatar online">
              <div className="w-16 rounded-full">
                <img src="/assets/images/user/user-01.png" />
              </div>
            </div>
          </div>
...
function CourseRatings() {
  ...
  return (
    <div className="group md:mt-4 p-6 md:p-0 max-w-3xl w-full items-center justify-start">
      <div className="flex justify-between items-center py-auto">
      ...
      <div className="flex flex-nowrap overflow-x-auto w-full"></div>
