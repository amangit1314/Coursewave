...
const Profile = () => {
    return (
        <>
            ...
            <div className="overflow-hidden rounded-sm border border-stroke bg-slate-900 shadow-default dark:border-strokedark dark:bg-slate-900">
                   ...
                   <ProfileImage />
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex justify-center items-center pt-auto">
                            <FcGoogle size={20} />
                            <p className="pl-1.5 text-sm font-normal">amansoni@gmail.com</p>
                        </div>

                        {/* switch to instructor view */}
                        <button
                           
                            className="my-3 cursor-pointer font-bold text-blue-500 dark:text-blue-400 hover:bg-blue-700 hover:p-1 hover:w-full hover:bg-opacity-50 hover:text-opacity-100 rounded-lg hover:text-white">Switch to instructor view
                        </button>
                       

                        {/* courses, followers, following */}
                        {/* <div className="mx-auto mt-4 mb-5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                        ...
                        {/* <div className="mx-auto max-w-180">
                            <p className="font-semibold mt-8 text-black dark:text-white">
                                About Me
                            </p>
                            <p className="mt-4">
                        ...
                        <div className="mt-8">
                            <h4 className="mb-2 text-sm font-normal text-black dark:text-white">
                                Follow <span className="text-blue-400 font-medium">coursewave</span> on
                            </h4>
...
function AccountSettingsSection() {
    return <div className="flex mt-4 flex-col items-start">
        <p className="text-xs py-1 text-gray-300">Account Settings</p>
        <div className="flex flex-col max-w-7xl w-full">
            <div className="flex py-1  items-center py-auto justify-between">
                <p className="text-sm">Career goal</p>
                {/* <div className="mx-[5rem]" /> */}
                <MdOutlineKeyboardArrowRight />
            </div>
            <div className="flex py-1  items-center py-auto justify-between">
                <p className="text-sm">Email notification preferences</p>
                {/* <div className="mx-[5rem]" /> */}
                <MdOutlineKeyboardArrowRight />
            </div>
            <div className="flex py-1  items-center py-auto justify-between">
...
function HelpAndSupportSection() {
    return <div className="mt-4 flex flex-col items-start">
        <p className="text-xs py-1 text-gray-300">Help and Support</p>
        <div className="flex flex-col max-w-7xl w-full">
            <div className="flex py-1  items-center py-auto justify-between">
...
function ProfileImage() {
    // const [selectedImage, setSelectedImage] = React.useState("/images/user/user-06.png");
