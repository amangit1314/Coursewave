...
//         return;
//       }
//       toast.error(error.response?.data?.message || "Failed to become an instructor. Please try again.");
//     }
//   };
...
//                 <AvatarImage
//                   src={user?.profileImageUrl || "/assets/images/user/user-01.png"}
//                   alt={user?.name || "User"}
//                 />
...
//                 <h1 className="text-3xl font-bold truncate">{user?.name || "User Name"}</h1>
//                 {isInstructor && (
//                   <Badge className="bg-gradient-to-r from-orange-500 to-red-500 text-white border-0 flex-shrink-0">
//                     <Crown className="h-3 w-3 mr-1" />
//                     Instructor
//                   </Badge>
//                 )}
//               </div>
//               <p className="text-lg text-white/80 mb-2 line-clamp-2">Full Stack Developer & Course Creator. Helping aspiring developers learn the skills they need to succeed in the tech industry.</p>
//               <div className="flex items-center gap-x-4 gap-y-2 text-sm text-white/70 flex-wrap">
//                 <div className="flex items-center gap-1 min-w-0">
//                   <Mail className="h-4 w-4 flex-shrink-0" />
//                   <span className="truncate">{user?.email || "user-long-name@example.com"}</span>
//                 </div>
//                 <div className="flex items-center gap-1 min-w-0">
//                   <MapPin className="h-4 w-4 flex-shrink-0" />
//                   <span className="truncate">San Francisco, California</span>
//                 </div>
...
//                     </div>
//                   </div>
//                   <div className="flex items-center justify-between p-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white">
...
//                     onClick={() => router.push('/sessions/browseSessions')}
//                   >
...
//                           <p className="font-medium text-zinc-900 dark:text-white truncate">Notifications</p>
//                           <p className="text-sm text-zinc-500 dark:text-zinc-400 truncate">Manage your notifications</p>
//                         </div>
//                       </div>
...
//                         </div>
//                         <div className="overflow-hidden">
//                           <p className="font-medium text-zinc-900 dark:text-white truncate">About CourseWave</p>
//                           <p className="text-sm text-zinc-500 dark:text-zinc-400 truncate">Learn more about us</p>
//                         </div>
//                       </div>
//                       <ChevronRight className="h-4 w-4 text-zinc-400 flex-shrink-0" />
//                     </div>
...
//                         </div>
//                         <div className="overflow-hidden">
//                           <p className="font-medium text-zinc-900 dark:text-white truncate">Share App</p>
//                           <p className="text-sm text-zinc-500 dark:text-zinc-400 truncate">Share with friends</p>
//                         </div>
//                       </div>
//                       <ChevronRight className="h-4 w-4 text-zinc-400 flex-shrink-0" />
//                     </div>
...
//                     <Link
//                       href="#"
//                       className="p-3 rounded-full bg-gradient-to-r from-pink-500 to-red-500 text-white hover:scale-110 transition-transform"
//                     >
//                       <RiInstagramFill size={20} />
//                     </Link>
//                     <Link
//                       href="#"
//                       className="p-3 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:scale-110 transition-transform"
//                     >
//                       <FaSquareXTwitter size={20} />
//                     </Link>
//                     <Link
//                       href="#"
//                       className="p-3 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:scale-110 transition-transform"
//                     >
//                       <FaLinkedinIn size={20} />
//                     </Link>
//                     <Link
//                       href="#"
//                       className="p-3 rounded-full bg-gradient-to-r from-gray-700 to-gray-800 text-white hover:scale-110 transition-transform"
//                     >
//                       <FaGithub size={20} />
//                     </Link>
//                   </div>
...
//             </div>
//             <div className="overflow-hidden">
//               <p className="font-medium text-zinc-900 dark:text-white truncate">Edit Profile</p>
//               <p className="text-sm text-zinc-500 dark:text-zinc-400 truncate">Update your profile information</p>
//             </div>
//           </div>
//           <ChevronRight className="h-4 w-4 text-zinc-400 flex-shrink-0" />
//         </div>
...
//           </DialogTitle>
//           <DialogDescription>
//             Make changes in your username and image here. Click save when you&apos;re done.
//           </DialogDescription>
//         </DialogHeader>
//         <Form {...form}>
//           <form
...
//             </div>
//             <div className="overflow-hidden">
//               <p className="font-medium text-zinc-900 dark:text-white truncate">Change Password</p>
//               <p className="text-sm text-zinc-500 dark:text-zinc-400 truncate">Update your password</p>
//             </div>
//           </div>
//           <ChevronRight className="h-4 w-4 text-zinc-400 flex-shrink-0" />
//         </div>
...
//             Make changes in your password here. Click save when you&apos;re done.
//           </DialogDescription>
//         </DialogHeader>
//         <Form {...form}>
//           <form
...
//             </div>
//             <div className="overflow-hidden">
//               <p className="font-medium text-zinc-900 dark:text-white truncate">Delete Account</p>
//               <p className="text-sm text-zinc-500 dark:text-zinc-400 truncate">Permanently delete your account</p>
//             </div>
//           </div>
//           <ChevronRight className="h-4 w-4 text-zinc-400 flex-shrink-0" />
//         </div>
              ...
              <Card className="border-0 shadow-lg bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    {!isInstructor ? (
                      <>
                        <PiStudentFill className="h-4 w-4 mr-2" />
                        Become Instructor
                      </>
                    ) : (
                      <>
...
const EditProfileWidget = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      const response = await axios.put(`api/profile/${user.user?.id}/`, {
        newUserName: values.userName,
        newProfileImageUrl: imageUrl,
      });
      console.log("Form Values: ", values);
  ...
  const onSubmit = async (values: z.infer<typeof changePasswordFormSchema>) => {
    try {
      const response = await axios.patch(
        `api/profile/${user.user?.id}/changePassword`,
        {
          oldPassword: values.oldPassword,
          newPassword: values.newPassword,
        }
...
const DeleteAccountWidget = () => {
  ...
  const handleDeleteAccount = async () => {
    try {
      await axios.delete(`api/profile/${user.user?.id}`);
