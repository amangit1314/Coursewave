...
import { RatingStars } from "@/app/(browseCourses)/browseCourses/(routes)/courseDetails/_components/rating-stars";
import Reviewcard from "@/app/(browseCourses)/browseCourses/(routes)/courseDetails/_components/review-card";
