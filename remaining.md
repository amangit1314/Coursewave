...
[] Correct what we offer ui and navigation on tap
[] Make brwose different course categories dynamic or remove this section
...
[] Fix shadow of empower your future with modern learning items in light mode
[] arrow Color and border color of the bottom footer in mobile view, 
--------------------------------------------------------------------------------------------------

[] No option for theme switch on login screen
[] Sign in with google should be white if the bg is blue
[] On hover of the eye icon, the pointer must be cursor.
...
[] Same make the eye icon cursor pointer
